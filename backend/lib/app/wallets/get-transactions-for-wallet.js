...
exports.getTransactionsForWallets = exports.getTransactionsForWalletId = void 0;
...
const getTransactionsForWalletId = async ({ walletId, }) => {
    ...
    return (0, exports.getTransactionsForWallets)([wallet]);
};
exports.getTransactionsForWalletId = getTransactionsForWalletId;
const getTransactionsForWallets = async (wallets) => {
    ...
    if (ledgerTransactions instanceof ledger_1.LedgerError)
        return partial_result_1.PartialResult.err(ledgerTransactions);
...
exports.getTransactionsForWallets = getTransactionsForWallets;
//# sourceMappingURL=get-transactions-for-wallet.js.map