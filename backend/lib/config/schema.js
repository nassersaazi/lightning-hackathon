...
const primitives_1 = require("../domain/accounts/primitives");
const fiat_1 = require("../domain/fiat");
const shared_1 = require("../domain/shared");
const displayCurrencyConfigSchema = {
    type: "object",
    properties: {
        code: { type: "string", enum: Object.values(fiat_1.DisplayCurrency) },
        symbol: { type: "string" },
    },
...
exports.configSchema = {
    ...
    properties: {
        ...
        accounts: {
            type: "object",
            properties: {
                initialStatus: { type: "string", enum: Object.values(primitives_1.AccountStatus) },
                initialWallets: {
                    type: "array",
                    items: {
                        type: "string",
        ...
        oathkeeperConfig: {
            ...
            additionalProperties: false,
            default: {
                urlJkws: `http://${process.env.OATHKEEPER_HOST ?? "oathkeeper"}:4456/.well-known/jwks.json`,
                decisionsApi: `http://${process.env.OATHKEEPER_HOST ?? "oathkeeper"}:4456/decisions/`,
            },
        },
        captcha: {
            type: "object",
