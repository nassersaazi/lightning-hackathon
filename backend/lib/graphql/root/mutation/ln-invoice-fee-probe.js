...
const _1 = require(".");
const LnInvoiceFeeProbeInput = index_1.GT.Input({
...
const LnInvoiceFeeProbeMutation = index_1.GT.Field({
    extensions: {
        complexity: 120,
    },
    type: index_1.GT.NonNull(sat_amount_1.default),
    args: {
        input: { type: index_1.GT.NonNull(LnInvoiceFeeProbeInput) },
    },
...
exports.default = LnInvoiceFeeProbeMutation;
//# sourceMappingURL=ln-invoice-fee-probe.js.map