...
exports.mapAndParseErrorForGqlResponse = exports.mapError = void 0;
...
const mapError = (error) => {
    ...
    switch (errorName) {
        case "WithdrawalLimitsExceededError":
            ...
            return new error_1.TransactionRestrictedError({ message, logger: logger_1.baseLogger });
        ...
        case "TwoFALimitsExceededError":
            ...
            return new error_1.TwoFAError({ message, logger: logger_1.baseLogger });
        case "AlreadyPaidError":
            message = "Invoice is already paid";
            return new error_1.LightningPaymentError({ message, logger: logger_1.baseLogger });
        ...
        case "CouldNotFindUserFromIdError":
            ...
            return new error_1.NotFoundError({ message, logger: logger_1.baseLogger });
        ...
        case "SelfPaymentError":
            ...
            return new error_1.SelfPaymentError({ message, logger: logger_1.baseLogger });
        case "LnInvoiceMissingPaymentSecretError":
            message = "Invoice is missing its 'payment secret' value";
            return new error_1.InvoiceDecodeError({ message, logger: logger_1.baseLogger });
        ...
        case "LnPaymentRequestInTransitError":
            ...
            return new error_1.ValidationInternalError({ message, logger: logger_1.baseLogger });
        ...
        case "PhoneProviderConnectionError":
            ...
            return new error_1.PhoneProviderError({ message, logger: logger_1.baseLogger });
        ...
        case "InvoiceCreateForRecipientRateLimiterExceededError":
            ...
            return new error_1.TooManyRequestError({ message, logger: logger_1.baseLogger });
        ...
        case "CouldNotFindPhoneCodeError":
            ...
            return new error_1.PhoneCodeError({ message, logger: logger_1.baseLogger });
        ...
        case "NoConnectionToDealerError":
            ...
            return new error_1.DealerOfflineError({ message, logger: logger_1.baseLogger });
        ...
        case "RouteNotFoundError":
            ...
            return new error_1.RouteFindingError({ message, logger: logger_1.baseLogger });
        ...
        case "InsufficientOnChainFundsError":
            ...
            return new error_1.InsufficientLiquidityError({ message, logger: logger_1.baseLogger });
        case "CPFPAncestorLimitReachedError":
            ...
            return new error_1.OnChainPaymentError({ message, logger: logger_1.baseLogger });
        ...
        case "UsernameNotAvailableError":
            ...
            return new error_1.UsernameError({ message, logger: logger_1.baseLogger });
        ...
        case "InsufficientBalanceError":
            message = error.message;
            return new error_1.InsufficientBalanceError({ message, logger: logger_1.baseLogger });
        ...
        case "OnChainServiceUnavailableError":
            ...
            const serviceType = errorName === "OffChainServiceUnavailableError" ? "Offchain" : "Onchain";
            message = `${serviceType} action failed, please try again in a few minutes. If the problem persists, please contact support.`;
            return new error_1.LndOfflineError({ message, logger: logger_1.baseLogger });
        case "InactiveAccountError":
            message = "Account is inactive.";
            return new error_1.ValidationInternalError({ message, logger: logger_1.baseLogger });
        case "InvalidCoordinatesError":
            return new error_1.InvalidCoordinatesError({ logger: logger_1.baseLogger });
        case "InvalidBusinessTitleLengthError":
            return new error_1.InvalidBusinessTitleLengthError({ logger: logger_1.baseLogger });
        case "RebalanceNeededError":
            return new error_1.RebalanceNeededError({ logger: logger_1.baseLogger });
        ...
        case "DbConnectionClosedError":
            ...
            return new error_1.DbError({ message, logger: logger_1.baseLogger });
        // ----------
        ...
        case "IncompatibleSchemaUpgradeError":
            message = `Unexpected error occurred, please try again or contact support if it persists (code: ${error.name}${error.message ? ": " + error.message : ""})`;
            return new error_1.UnexpectedClientError({ message, logger: logger_1.baseLogger });
        // ----------
        // Unknown below here
        // ----------
        ...
        case "UnknownLedgerError":
            ...
            return new error_1.DbError({ message, logger: logger_1.baseLogger, level: "fatal" });
        ...
        case "UnknownKratosError":
            message = `Unknown error occurred (code: ${error.name})`;
            return new error_1.UnknownClientError({ message, logger: logger_1.baseLogger });
...
const mapAndParseErrorForGqlResponse = (err) => {
    const mappedError = (0, exports.mapError)(err);
    return {
...
exports.mapAndParseErrorForGqlResponse = mapAndParseErrorForGqlResponse;
