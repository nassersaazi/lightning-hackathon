...
if (_config_1.isDev && !_config_1.isRunningJest) {
    Promise.resolve().then(() => __importStar(require("../../services/fs"))).then(({ writeSDLFile }) => {
        writeSDLFile(__dirname + "/schema.graphql", (0, graphql_1.printSchema)((0, graphql_1.lexicographicSortSchema)(exports.gqlMainSchema)));
    });
}
exports.gqlMainSchema = new graphql_1.GraphQLSchema({
